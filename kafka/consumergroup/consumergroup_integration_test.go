...
func Skip_ExampleConsumerGroup() {
...
func Skip_TestIntegrationMultipleTopicsSingleConsumer(t *testing.T) {
...
func Skip_TestIntegrationSingleTopicParallelConsumers(t *testing.T) {
...
func Skip_TestSingleTopicSequentialConsumer(t *testing.T) {

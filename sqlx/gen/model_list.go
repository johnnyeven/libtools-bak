...
// deprecated
func ({{ var .StructName }}List *{{ .StructName }}List) {{ $method }}(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB, size int32, offset int32, conditions ...*{{ use "github.com/johnnyeven/libtools/sqlx/builder" }}.Condition) (count int32, err error)	{
	*{{ var .StructName }}List, count, err = (&{{ .StructName }}{}).FetchList(db, size, offset, conditions...)
	return
}

func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB, size int32, offset int32, conditions ...*{{ use "github.com/johnnyeven/libtools/sqlx/builder" }}.Condition) ({{ var .StructName }}List {{ .StructName }}List, count int32, err error) {
	...
	errForCount := db.Do(stmt.For({{ use "github.com/johnnyeven/libtools/sqlx/builder" }}.Count({{ use "github.com/johnnyeven/libtools/sqlx/builder" }}.Star()))).Scan(&count).Err()
	if errForCount != nil {
		err = errForCount
		return
	}
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB, condition *{{ use "github.com/johnnyeven/libtools/sqlx/builder" }}.Condition) ({{ var .StructName }}List {{ .StructName }}List, err error) {
	{{ var .StructName }}List = {{ .StructName }}List{}
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB) ({{ var .StructName }}List {{ .StructName }}List, err error) {
	{{ var .StructName }}List = {{ .StructName }}List{}
...
// deprecated
func ({{ var .StructName }}List *{{ .StructName }}List) BatchFetchBy{{ $field }}List(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB, {{ var $field }}List []{{ $fieldType }}) (err error)	{
	*{{ var .StructName }}List, err = (&{{ .StructName }}{}).BatchFetchBy{{ $field }}List(db, {{ var $field }}List)
	return
}

func ({{ var .StructName }} *{{ .StructName }}) BatchFetchBy{{ $field }}List(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB, {{ var $field }}List []{{ $fieldType }}) ({{ var .StructName }}List {{ .StructName }}List, err error) {

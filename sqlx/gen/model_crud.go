...
func (m *Model) methodsForBasic() string {
	...
	m.ParseTo(buf, `
	{{ $method := "Create"}}
	func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB) error {
	{{ ( .EnableIfNeed ) }}
	{{ ( .SetCreatedAtIfNeed ) }}
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB) (err error) {
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB, updateFields []string) error {
	...
	fieldValues := {{ use "github.com/johnnyeven/libtools/sqlx" }}.FieldValuesFromStructByNonZero({{ var .StructName }}, updateFields...)
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB) error {
	...
	stmt := table.Select().
		Comment("{{ .StructName }}.{{ $method }}").
		Where({{ use "github.com/johnnyeven/libtools/sqlx/builder" }}.And(
			%s
		))
...
{{ $method := "%s" }}
{{ $methodForFetch := "%s" }}
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB, fieldValues {{ use "github.com/johnnyeven/libtools/sqlx/builder" }}.FieldValues) error {
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB, zeroFields ...string) error {
	fieldValues := {{ use "github.com/johnnyeven/libtools/sqlx" }}.FieldValuesFromStructByNonZero({{ var .StructName }}, zeroFields...)
...
func ({{ var .StructName }} *{{ .StructName }}) {{ $method }}(db *{{ use "github.com/johnnyeven/libtools/sqlx" }}.DB) error {
	...
	fieldValues := {{ use "github.com/johnnyeven/libtools/sqlx/builder" }}.FieldValues{}
	...
	err := dbRet.Err()
	if err != nil {
		dbErr := {{ use "github.com/johnnyeven/libtools/sqlx" }}.DBErr(err)
		if dbErr.IsConflict() {

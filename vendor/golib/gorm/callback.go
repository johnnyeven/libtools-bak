...
type callback struct {
	...
	batch_creates []*func(scope *Scope)
...
func (c *callback) BatchCreate() *callbackProcessor {
	return c.addProcessor("batch_create")
}
...
func (c *callback) sort() {
	var creates, batch_creates, updates, deletes, queries, rowQueries []*callbackProcessor
	...
	for _, processor := range c.processors {
		...
		case "batch_create":
			batch_creates = append(batch_creates, processor)
		case "update":
	...
	c.batch_creates = sortProcessors(batch_creates)
